...
const features = [
  {
    ...
    description: "Get an interactive visual map of your system. Complex dependencies become clear in seconds, not hours, with our automated tool.",
  ...
  },
  {
    ...
    description: "Your visuals and tutorials are dynamically processed in real-time, providing an accurate reflection of your current system and its components.",
    highlight: "Auto-sync",
    svg: anim3,
  ...
  },
  {
    ...
    description: "Ask questions like 'Which services depend on payments?' and get an instant, interactive visual map backed by exact code references.",
